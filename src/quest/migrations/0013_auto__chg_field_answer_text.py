...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('quest_answer', 'text', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Answer.text'
        db.alter_column('quest_answer', 'text', self.gf('django.db.models.fields.TextField')(default=''))
