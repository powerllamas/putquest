...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('quest_answer_choices', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm['quest.answer'], null=False)),
            ('questionchoice', models.ForeignKey(orm['quest.questionchoice'], null=False))
        ))
        db.create_unique('quest_answer_choices', ['answer_id', 'questionchoice_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field choices on 'Answer'
        db.delete_table('quest_answer_choices')
