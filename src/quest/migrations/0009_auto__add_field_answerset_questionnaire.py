...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnswerSet.questionnaire'
        db.add_column('quest_answerset', 'questionnaire', self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['quest.Questionnaire']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnswerSet.questionnaire'
        db.delete_column('quest_answerset', 'questionnaire_id')
