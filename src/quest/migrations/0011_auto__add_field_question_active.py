...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('quest_question', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.active'
        db.delete_column('quest_question', 'active')
