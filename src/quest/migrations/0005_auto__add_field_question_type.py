...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('quest_question', 'type', self.gf('django.db.models.fields.CharField')(default=u'single_selection', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.type'
        db.delete_column('quest_question', 'type')
