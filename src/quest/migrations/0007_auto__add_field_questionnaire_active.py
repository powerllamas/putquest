...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Questionnaire.active'
        db.add_column('quest_questionnaire', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Questionnaire.active'
        db.delete_column('quest_questionnaire', 'active')
